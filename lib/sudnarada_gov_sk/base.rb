...
module SudnaradaGovSk
  module Base
    ...
    def build_request(type, options = {})
      ...
      inject SudnaradaGovSk::Request, implementation: type, suffix: :List, args: args
    end
    
    def build_lister(type, options = {})
      args = build_args type, options
      
      inject SudnaradaGovSk::Crawler, implementation: type, suffix: :List, args: args
    end
    ...
    def build_crawler(type, options = {})
      ...
      inject SudnaradaGovSk::Crawler, implementation: type, args: args
    end      
