class CreateStatisticalTables < ActiveRecord::Migration
  def change
    ...
    add_index :statistical_tables, [:statistical_summary_id, :statistical_summary_type, :statistical_table_name_id],
      unique: true, name: 'index_statistical_tables_on_summary_and_name'
